...
# Generate mesh  
def DoTriMesh(points,vertices,edge_length=-1,holes=[],tri_refine=None, min_angle=None):
  ...
  if tri_refine!=None:
    ...
    mesh = triangle.build(info,max_volume=0.5*edge_length**2, min_angle=min_angle)
